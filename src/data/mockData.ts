...
export const tagSuggestionsByCategory = {
  "Web App": [
    "React", "Vue.js", "Angular", "NextJS", "Nuxt.js",
  ...
  "Mobile App": [
    ...
    "Firebase", "SQLite", "React Navigation", "Redux",
    "Native Base", "Tamagui", "Styled Components",
    "Push Notifications", "Async Storage", "Camera",
  ...
  "Desktop App": [
    ...
    "Python", "C++", "C#", "JavaFX", "Swing",
    "Cross Platform", "Windows", "macOS", "Linux",
    "SQLite", "Local Storage", "File System", "Auto Update"
  ]
};

// General technology tags for any type of project
export const generalTechTags = [
  "API Integration", "Authentication", "Authorization", "Database",
  "Real-time", "WebSocket", "Payment", "Email", "SMS",
  "Cloud Storage", "File Upload", "Image Processing",
  "Search", "Filters", "Pagination", "Charts", "Maps",
  "Notifications", "Admin Panel", "Dashboard", "CRUD",
  "Responsive", "PWA", "Performance", "Security", "Testing"
];
